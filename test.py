...
#PART 1.1: generate initial and goal configurations (inverse_geometry.py)
...
#PART 1.2: plan path (list of configs) between initial and goal configurations (path.py)
from path import computepath
G = computepath(robot,cube, q_start[0],q_final[0],CUBE_PLACEMENT, CUBE_PLACEMENT_TARGET,viz)
G = G[0]


#PART 2 is fully implemented in control.py
#The rest of the code here is Part 2.1 (parameterise path into trajectory - level 0)
